...
namespace Boodschappen
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            static void btwBerekenen(double prijsExcl)
            {
                double btw = prijsExcl * 0.21;
                double prijsIncl = prijsExcl + btw;
                Console.WriteLine("Je boodschappen kosten " + prijsIncl + " euro. (incl. BTW)");
            }
            btwBerekenen(prijs);
        }
    }
